...
function ProdutoDetalhe({ onAddToCart, onCalcularFrete }: ProdutoDetalheProps) {
						...
						<div className="mb-6">
							...
							<div className="bg-gray-50 rounded-lg p-4 mb-6">
								<div className="flex items-start gap-2 mb-3">
									<Truck size={24} className="text-indigo-900" />
							...
							<div className="mb-6">
								<div className="flex items-center gap-2 mb-3">
									<CreditCard size={24} className="text-indigo-900" />
