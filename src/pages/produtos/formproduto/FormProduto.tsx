...
function FormProduto() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100 p-4">
      <div className="container px-4 flex flex-col mx-auto items-center bg-white rounded-lg shadow p-6 w-full sm:w-4/5 md:w-3/4 lg:w-2/3 xl:w-1/2">
        ...
        <form className="flex flex-col w-full gap-4" onSubmit={onSubmit}>
          ...
          <button
            ...
            className="flex justify-center rounded disabled:bg-gray-400 bg-indigo-900 
                    hover:bg-indigo-600 text-white font-bold w-full sm:w-2/3 md:w-1/2 mx-auto py-2 mt-4 mb-4"
          >
            {isLoading ? (
              <RotatingLines
                strokeColor="white"
