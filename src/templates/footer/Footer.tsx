		...
		<footer className="bg-indigo-900 text-white py-8">
						...
						{activeAccordion === "contato" && (
							<div className="pb-4 space-y-2">
								<div className="text-gray-300 flex gap-2 items-center">
									<MapPin size={28} weight="bold" color="#ffffff" /> Rua dos
									Livros, 123 - São Paulo, SP
								</div>
								<div className="text-gray-300 flex gap-2 items-center">
									<Phone size={28} weight="bold" color="#ffffff" /> (11)
									98765-4321
								</div>
								<div className="text-gray-300 flex gap-2 items-center">
			...
			<div className="mt-8 text-center">
				...
				<div className="flex justify-center space-x-4">
					<a href="#" target="_blank" className="hover:opacity-75 transition-opacity">
